...
const PrivacyPolicy = () => {
  return (
    <div className="bg-white">
      <Seo
        title="Privacy Policy | Business Bureau Coworking"
        description="Read the Privacy Policy for Business Bureau Coworking in Kerala. Learn how we handle and protect your personal information with full transparency."
        url="https://www.businessbureau.in/privacy-policy"
      />
      <Header />
      <main className="bg-gray-50 min-h-screen">
        ...
        <section className="max-w-5xl mx-auto px-6 py-12 space-y-10 text-gray-800 leading-relaxed">
          ...
          <div id="infocollect">
            ...
            <p className="mt-2">We may collect personal information such as:</p>
          ...
          <div id="cookies">
            ...
            <p>
              ...
              experience, analyze traffic, and ensure security.
            </p>
          </div>
