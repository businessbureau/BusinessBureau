...
const TermsAndCondition = () => {
  return (
    <div className="bg-white">
      <Seo
        title="Terms & Conditions | Business Bureau Coworking"
        description="Review the Terms and Conditions for Business Bureau Coworking. Our professional standards and usage policies for workspaces in Kochi and beyond."
        url="https://www.businessbureau.in/terms-and-conditions"
      />
      <Header />
        ...
        <section className="max-w-5xl mx-auto px-6 py-12 space-y-10 text-gray-800 leading-relaxed">
          ...
          <div>
            <p>
              ...
              website operated by <strong>Business Bureau</strong> ("we", "our",
              or "us"). By accessing or using our website, you agree to be bound
          ...
          <div>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>
                You shall not misuse, hack, or attempt to disrupt our services.
              </li>
            </ul>
          </div>
          ...
          {/* User Submissions */}
          <div>
            <h2 className="text-2xl font-semibold mb-3">3. User Submissions</h2>
            <p>
          ...
          <div>
            ...
            <p>
              To the maximum extent permitted by law, Business Bureau shall not
